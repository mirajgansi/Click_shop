...
void main() {
  ...
  test('returns all products when repository call succeeds', () async {
    when(
    ...
    verify(() => repository.getAllproduct()).called(1);
    verifyNoMoreInteractions(repository);
  });

  test('returns failure when repository call fails', () async {
    final failure = ApiFailure(message: 'Failed to fetch products');
