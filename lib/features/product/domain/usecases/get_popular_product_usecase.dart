...
final getPopularProductsUsecaseProvider = Provider<GetPopularProductsUsecase>((
  ref,
) {
  final repo = ref.read(productRepositoryProvider);
  return GetPopularProductsUsecase(productRepository: repo);
});
...
class GetPopularProductsUsecase
  ...
  GetPopularProductsUsecase({required IProductRepository productRepository})
