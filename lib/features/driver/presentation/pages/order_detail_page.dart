import 'package:click_shop/core/services/sensors/proximity_sensor_widget.dart';
...
class DriverOrderDetailPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ProximitySensorWidget(
      enabled: order.status == OrderStatus.shipped, // only active when shipped
      onNear: () async {
        final ok = await DriverOrderDialogs.confirmDelivered(context);
        if (!ok) return;
